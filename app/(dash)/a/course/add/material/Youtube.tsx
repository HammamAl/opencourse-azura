    ...
    <div className="relative group bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      <div className="relative aspect-video">
        ...
        <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            onClick={onEdit}
            className="p-2 bg-blue-500 bg-opacity-90 text-white rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-lg"
            title="Edit video"
          >
            <Edit />
          </button>
          {onRemove && (
            <button
              onClick={onRemove}
              className="p-2 bg-red-500 bg-opacity-90 text-white rounded-full hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 shadow-lg"
              title="Remove video"
            >
              <X className="h-4 w-4" />
            </button>
